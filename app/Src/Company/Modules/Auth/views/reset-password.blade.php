    ...
    <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
        <div class="d-flex flex-center flex-column flex-lg-row-fluid">
            <div class="w-lg-500px p-10">
                <form class="form w-100" wire:submit="submit">
                    <x-panel::loader target="submit" />
                    <div class="text-center mb-11">
                        <h1 class="text-gray-900 fw-bolder mb-3">{{__('company.reset-password.title')}}</h1>
                        <div
                            class="text-gray-500 fw-semibold fs-6">{{__('company.reset-password.sub_title',['site_name' => config('app.name')])}}</div>
                    </div>
                    <x-panel::alert />
                    ...
                    <div class="d-flex flex-wrap justify-content-center pb-lg-0">
                        ...
                        <a href="{{route('company.auth.login')}}" wire:navigate
