                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 fv-row">
                                <input type="number" id="opening_balance" maxlength="12" name="openingBalance"
                                    wire:model.blur="form.openingBalance" min="0" step="any"
                                    class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="col-md-6 d-flex align-items-end mb-4">
                        ...
                        <div class="col-md-5 d-flex align-items-center justify-content-start">
                            ...
                            <div wire:loading wire:target="addProduct" class="mt-2 text-info">
                                <i class="fa-solid fa-spinner fa-spin me-1 text-info"></i> Adding product...
                            </div>
                        </div>
                    </div>
                    ...
                    @foreach ($selectedProducts as $selectedProduct)
                        <div class="col-md-3 mb-4">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-solid"
                                    wire:model.blur="selectedProducts.{{ $loop->index }}.name" readonly>
                                <x-panel::error name="selectedProducts.{{ $loop->index }}.name" />
                                <x-panel::error name="selectedProducts.{{ $loop->index }}.id" />
                        </div>
                        ...
                        <div class="col-md-2">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6">
                                ...
                                <input type="number" class="form-control form-control-lg form-control-solid"
                                    wire:model.blur="selectedProducts.{{ $loop->index }}.product_price_new"
                                    placeholder="Please Enter Special Price">
                                </lable>
                                <x-panel::error name="selectedProducts.{{ $loop->index }}.product_price_new" />
                        </div>
                        ...
                        <div class="col-md-2">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6">
                                ...
                                <input type="number" class="form-control form-control-lg form-control-solid"
                                    wire:model.blur="selectedProducts.{{ $loop->index }}.product_price"
                                    placeholder="Please Enter Default Price">
                                </lable>
                                <x-panel::error name="selectedProducts.{{ $loop->index }}.product_price" />
                        </div>
                        <div class="col-md-2">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6">
                                Customer Min Amount
                                ...
                                <input type="number" class="form-control form-control-lg form-control-solid"
                                    wire:model.blur="selectedProducts.{{ $loop->index }}.customer_min_amount"
                                    placeholder="Please Enter Customer Min Amount">
                                </lable>
                                <x-panel::error name="selectedProducts.{{ $loop->index }}.customer_min_amount" />
                        </div>
                        <div class="col-md-2">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6">
                                Product Min Amount
                                ...
                                <input type="number" class="form-control form-control-lg form-control-solid"
                                    wire:model.blur="selectedProducts.{{ $loop->index }}.product_min_amount" readonly>
                                </lable>
                                <x-panel::error name="selectedProducts.{{ $loop->index }}.product_min_amount" />
                        </div>
