                        ...
                        @if($jobcarddata->isNotEmpty() || $jobcardcom->isNotEmpty())
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="px-4">
                                        <h5 class="card-title">Description : <span x-text="selectedJobDetails.description"></span></h5>
                                       
                                    </div>
                                    <hr class="w-25 mt-1">
                                    <div class="px-4">
                                        <h5 class="card-title">Product Name :<span x-text="selectedJobDetails.product_name"></span></h5>
    ...
    <div class="card card-stretch card-bordered mb-2">
        @if($jobcarddata->isNotEmpty() || $jobcardcom->isNotEmpty())
            <div class="card-header py-3">
                <h3 class="card-title mb-0">Job Name : # <span x-text="selectedJob" style="cursor: pointer;" onclick="copyToClipboard(this)"></span></h3>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start flex-wrap">
                    ...
                    <div class="flex-grow-1 pe-4">
                        ...
                        <div class="mb-2">
                            <h5 class="card-title mb-1">Product Name : 
                        ...
                        <div class="mb-2">
                            ...
                            <h5 class="card-title mb-1">Sq.ft: 
                    ...
                    <div style="max-width: 200px;" class="text-end">
                        <img 
                            class="mw-100 mh-150px card-rounded shadow-sm" 
                           
                            :src="selectedJobDetails.image_url" 
                ...
                <hr class="my-3">
                <p class="mt-2" x-show="selectedJobDetails.description"><strong>Note:</strong> <span x-text="selectedJobDetails.description"></span></p>
            </div>
            ...
            <div class="card-footer text-center align-items-center py-2" x-show="selectedJobDetails.job_status === 'pending'" x-cloak>
                ...
                <button type="submit" class="btn btn-primary me-2" @click="$wire.markAsPrinted(selectedJobDetails.id)">
                    Printing Done
                </button>
            </div>
        @endif
                            ...
                            <div class="mb-3">
                                <div>
                                    <div class="form-check mb-2 ">
                                        <input class="form-check-input text-black" type="radio" name="damageType" id="wholeProduct" value="whole_product" wire:model="damageType" @click="showMaterialList = false" required>
                                        <label class="form-check-label text-black" for="wholeProduct">Whole Product</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input text-black" type="radio" name="damageType" id="materials" value="materials" wire:model="damageType" @click="showMaterialList = true" required>
                                        <label class="form-check-label text-black " for="materials">Materials</label>
                                    </div>
                                    @error('damageType') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            ...
                            <div x-show="showMaterialList" x-transition>
                                <div class="mb-3">
                                    ...
                                    <div x-show="showDimensions[{{ $material->id }}]" x-transition>
                                        <div class="row mb-5" >
                                            <div class="col-md-6">
                                                <input type="number" class="form-control text-black" id="height_{{ $material->id }}" wire:model="dimensions.{{ $material->id }}.height" placeholder="Height" min="1" 
                                                x-bind:required="showDimensions[{{ $material->id }}]">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="number" class="form-control text-black" id="width_{{ $material->id }}" wire:model="dimensions.{{ $material->id }}.width" placeholder="Width" min="1" 
                                                x-bind:required="showDimensions[{{ $material->id }}]">
                                            </div>
                                        </div>
                                    </div>
