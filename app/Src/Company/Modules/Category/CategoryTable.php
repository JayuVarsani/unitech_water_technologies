...
class CategoryTable extends BaseTable
{
    ...
    {
        return view('company::Category.views.table', [
            'items' => $this->dataSource(),
        ])->layout('panel::layout.app', ['title' => str()->plural(__('company.category'))]);
    }

    public function delete(Category $category): void
    {
        $category->delete();
        flashAlert(__('app.panel.delete', ['name' => __('company.category')]), 'success');
    }
