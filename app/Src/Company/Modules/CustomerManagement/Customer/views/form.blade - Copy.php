                ...
                <div class="row mb-6">
                    <div class="col-md-3">
                        <label class="col-lg-12 col-form-label fw-semibold fs-6 required" for="name">{{ __('company.input.customer_group')}}
                            <a href='#' wire:click.prevent="storeToSession" style='margin-left: 159px'> Add New</a></label>
...
<!-- Price add section start -->
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6 required" for="productId">{{ __('company.input.product')}}</label>
                            <div class="col-lg-12 fv-row">
                            <select class="form-select form-select-lg add-select2"  id="productId" wire:model="form.productId"
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6 required" for="product_price_new">{{ __('company.input.add_price')}}</label>
                            <div class="col-lg-12 fv-row">
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6 required" for="product_price">{{ __('company.input.default_price')}}</label>
                            <div class="col-lg-12 fv-row">
...
Alpine.data('custgroup', () => {
    ...
    $(document).ready(function () {
        ...
        $('.add-select2').on('change', function (e) {
            var selectedCustomerGroup = $('#customer_group option:selected').val();
            var selectedCustomerRegType = $('#customer_reg_type option:selected').val();
            var selectedAutoReminder = $('#auto_reminder option:selected').val();
            var selectedproduct = $('#productId option:selected').val();
            ...
            @this.set('form.productId', selectedproduct);

        });

    //  var preSelectedProductId = $('#ProductId option:selected').val();
    //      if (preSelectedProductId) {
    //                   @this.call('updateDefaultPrice', preSelectedProductId);
    //               }

    //      $('#ProductId').select2().on('change', function ()
    //      {
    //              @this.set('form.ProductId', $(this).val());
    //              @this.call('updateDefaultPrice', $(this).val());
