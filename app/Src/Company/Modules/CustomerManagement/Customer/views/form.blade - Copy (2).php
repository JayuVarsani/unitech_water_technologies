            ...
            if (event.key === "Enter") {
                ...
                if (form) {
                    ...
                    const focusableElements = Array.from(
                        ...
                        // If current element is "opening balance", move focus to "productId"
                        // if (event.target.id === "opening_balance") 
                        // {
                        //     console.log("Moving focus from Opening Balance to Product dropdown.");
                        //     const productDropdown = document.getElementById("productId");
                        //     if (productDropdown) {
                        //         productDropdown.focus();
                        //          productDropdown.click(); 
                        //         //                 productDropdown.size = productDropdown.options.length > 5 ? 5 : productDropdown.options.length; // Open dropdown effect
                        //         //                 // Ensure it stays open
                        //         // setTimeout(() => {
                        //         //     productDropdown.size = productDropdown.options.length > 5 ? 5 : productDropdown.options.length;
                        //         // }, 1000); 
