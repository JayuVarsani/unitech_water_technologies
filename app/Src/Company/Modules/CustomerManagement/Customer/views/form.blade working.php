...
<div x-data="custgroup">
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <form class="form" method="post" wire:submit="save" enctype="multipart/form-data" x-data="{ loading: false }"
            @submit="loading = true">
            @csrf
            <div class="card-body border-top p-6">
                <div class="row mb-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 fv-row">
                                <input type="text" id="name" maxlength="30" name="name"
                                    wire:model.blur="form.name" class="form-control form-control-lg form-control-solid"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 fv-row">
                                <input type="email" id="email" maxlength="30" name="email"
                                    wire:model.blur="form.email" class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            ...
                            <div class="col-lg-12 fv-row">
                                <input type="number" id="contact_number" maxlength="10" name="contactNumber"
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            ...
                            <div class="col-lg-12 fv-row">
                                <input type="number" id="whatsapp_number" maxlength="10" name="whatsappNumber"
                                    wire:model.blur="form.whatsappNumber"
                                    class="form-control form-control-lg form-control-solid"
                ...
                <div class="row mb-6">
                    <div class="col-md-3">
                        <div class="row">
                            ...
                            <div class="col-lg-12 fv-row">
                                <input type="text" id="address" maxlength="300" name="address"
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6 "
                                for="city">{{ __('company.input.city') }}</label>
                            <div class="col-lg-12 fv-row">
                                <input type="text" id="city" maxlength="30" name="city"
                                    wire:model.blur="form.city" class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6 "
                                for="state">{{ __('company.input.state') }}</label>
                            <div class="col-lg-12 fv-row">
                                <input type="text" id="state" maxlength="30" name="state"
                                    wire:model.blur="form.state"
                                    class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6 "
                                for="pincode">{{ __('company.input.pincode') }}</label>
                            <div class="col-lg-12 fv-row">
                                <input type="number" id="pincode" maxlength="30" name="pincode"
                                    wire:model.blur="form.pincode"
                                    class="form-control form-control-lg form-control-solid"
                ...
                <div class="row mb-6">
                    <div class="col-md-3">
                        <label class="col-lg-12 col-form-label fw-semibold fs-6 required"
                            ...
                            <a href='#' wire:click.prevent="storeToSession"
                                class="m-input-icon__icon m-input-icon__icon--right"> Add New</a></label>
                        <div wire:ignore class="col-lg-12 fv-row">
                            <select class="form-select form-select-lg add-select2" id="customer_group"
                                wire:model.blur="form.customerGroup">
                                <option value="">
                                    {{ __('company.placeholder.select', ['name' => __('company.input.customer_group')]) }}
                                </option>
                    ...
                    @if ($company_type == 'Regular')
                        <div class="col-md-2">
                            <div class="row">
                                <label class="col-lg-12 col-form-label fw-semibold fs-6"
                                    for="gstNo">{{ __('company.input.gst_no') }}</label>
                                <div class="col-lg-12 fv-row">
                                    <input type="text" id="gst_no" name="gstNo" wire:model.blur="form.gstNo"
                                        class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="col-md-3">
                        <label class="col-lg-12 col-form-label fw-semibold fs-6"
                            for="name">{{ __('company.input.auto_reminder') }}</label>
                        <div wire:ignore class="col-lg-12 fv-row">
                            <select class="form-select form-select-lg add-select2" wire:model="form.autoReminder"
                                id="auto_reminder">
                                <option value="">
                                    {{ __('company.placeholder.select', ['name' => __('company.input.auto_reminder')]) }}
                                </option>
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6 required"
                                for="openingBalance">{{ __('company.input.opening_balance') }} (₹)</label>
                            <div class="col-lg-12 fv-row">
                                <input type="number" id="opening_balance" maxlength="12" name="openingBalance"
                                    wire:model.blur="form.openingBalance"
                                    class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="col-md-3 d-flex align-items-end mb-4">
                        <div class="flex-grow-1 me-2">
                            <div class="row">
                                <label class="col-lg-12 col-form-label fw-semibold fs-6" for="productId">
                                    {{ __('company.input.product') }}
                                </label>
                                <div class="col-lg-12 fv-row" wire:ignore>
                                    <select class="form-select form-select-lg add-select2" id="productId"
                                        wire:model="form.productId">
                                        <option value="">
                                        ...
                                        @foreach ($product as $single_product)
                                            <option value="{{ $single_product->id }}">
                                                {{ $single_product->product_id }} - {{ $single_product->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        @if ($form->productId === 'all')
                            <div>
                                <button type="button" wire:click="addProduct"
                                    class="btn btn-primary btn-rounded" wire:loading.attr="disabled">
                                    <i class="fa-solid fa-plus"></i>
                                </button>
                                <!-- Loader when addProduct is running -->
                                <div wire:loading wire:target="addProduct" class="mt-2 text-info">
                                    <i class="fa-solid fa-spinner fa-spin me-1"></i> Adding product...
                                </div>
                            </div>
                        @endif
                    </div>
                    @if ($form->productId === 'all')
                        @foreach ($product as $single_product)
                            <div class="row align-items-end mb-3" wire:key="product-{{ $single_product->id }}">
                                <div class="col-md-3">
                                    <div class="row">
                                        <label class="col-lg-12 col-form-label fw-semibold fs-6 "
                                            for="productId">{{ __('company.input.product') }}</label>
                                        <div class="col-lg-12 fv-row">
                                            <select class="form-select form-select-lg add-select2" id="productId"
                                                wire:model="form.productId"
                                                wire:change="updateDefaultPrice($event.target.value)">
                                                <option value="{{ $single_product->id }}">
                                                    {{ $single_product->product_id }} - {{ $single_product->name }}
                                                </option>
                                ...
                                <div class="col-md-2">
                                    <div class="row">
                                        <label
                                            class="col-lg-12 col-form-label fw-semibold fs-6">{{ __('company.input.special_price') }}
                                            (₹)</label>
                                        <div class="col-lg-12 fv-row">
                                            <input type="number"
                                                wire:model.defer="form.product_price_new.{{ $single_product->id }}"
                                                class="form-control form-control-lg form-control-solid"
                                ...
                                <div class="col-md-2">
                                    <div class="row">
                                        <label
                                            class="col-lg-12 col-form-label fw-semibold fs-6">{{ __('company.input.default_price') }}
                                            (₹)</label>
                                        <div class="col-lg-12 fv-row">
                                            <input type="number"
                                                wire:model="form.product_price.{{ $single_product->id }}"
                                                class="form-control form-control-lg form-control-solid"
                                ...
                                <div class="col-md-2">
                                    <div class="row">
                                        <label
                                            class="col-lg-12 col-form-label fw-semibold fs-6">{{ __('company.input.customer_min_amount') }}
                                            (₹)</label>
                                        <div class="col-lg-12 fv-row">
                                            <input type="number"
                                                wire:model="form.customer_min_amount.{{ $single_product->id }}"
                                                class="form-control form-control-lg form-control-solid"
                                                placeholder="{{ __('company.placeholder.enter', ['name' => __('company.input.customer_min_amount')]) }}">
                                            <x-panel::error name="form.customer_min_amount.{{ $single_product->id }}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="row">
                                        <label
                                            class="col-lg-12 col-form-label fw-semibold fs-6">{{ __('company.input.product_min_amount') }}
                                            (₹)</label>
                                        <div class="col-lg-12 fv-row">
                                            <input type="number"
                                                    wire:model="form.product_min_amount.{{ $single_product->id }}"
                                                class="form-control form-control-lg form-control-solid" readonly 
                                                placeholder="{{ __('company.placeholder.enter', ['name' => __('company.input.product_min_amount')]) }}">
                                            <x-panel::error name="form.product_min_amount.{{ $single_product->id }}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div wire:loading.remove
                                        wire:target="deleteProductRow({{ $single_product->id }})">
                                        <a style="cursor: pointer"
                                            wire:click="deleteProductRow({{ $single_product->id }})">
                                            <i class="fa-solid fa-trash icon text-danger"></i>
                                        </a>
                                    </div>

                                    <div wire:loading wire:target="deleteProductRow({{ $single_product->id }})">
                    ...
                    {{-- @dump($form) --}}
                        ...
                        <div class="col-md-2">
                            <div class="row">
                                <label class="col-lg-12 col-form-label fw-semibold fs-6 "
                                    for="product_price_new">{{ __('company.input.special_price') }} (₹)</label>
                                <div class="col-lg-12 fv-row">
                        ...
                        <div class="col-md-2">
                            <div class="row">
                                <label class="col-lg-12 col-form-label fw-semibold fs-6 "
                                    for="product_price">{{ __('company.input.default_price') }} (₹)</label>
                                <div class="col-lg-12 fv-row">
                                    <input type="number" id="product_price" wire:model.blur="form.product_price"
                                        class="form-control form-control-lg form-control-solid"
                                        placeholder="{{ __('company.placeholder.enter', ['name' => __('company.input.default_price')]) }}">
                        ...
                        <div class="col-md-2">
                            <div class="row">
                                <label class="col-lg-12 col-form-label fw-semibold fs-6 "
                                    for="customer_min_amount">{{ __('company.input.customer_min_amount') }} (₹)</label>
                                <div class="col-lg-12 fv-row">
                                    <input type="number" id="customer_min_amount" wire:model.blur="form.customer_min_amount"
                                        class="form-control form-control-lg form-control-solid"
                                        placeholder="{{ __('company.placeholder.enter', ['name' => __('company.input.customer_min_amount')]) }}">
                                    <x-panel::error name="form.customer_min_amount" />
                                </div>
                            </div>
                        </div><div class="col-md-2">
                            <div class="row">
                                <label class="col-lg-12 col-form-label fw-semibold fs-6 "
                                    for="product_min_amount">{{ __('company.input.product_min_amount') }} (₹)</label>
                                <div class="col-lg-12 fv-row">
                                    <input type="number" id="product_min_amount" wire:model.blur="form.product_min_amount"
                                        class="form-control form-control-lg form-control-solid" readonly
                                        placeholder="{{ __('company.placeholder.enter', ['name' => __('company.input.product_min_amount')]) }}">
                                    <x-panel::error name="form.product_min_amount" />
                                </div>
                            </div>
                        </div>
                    @endif
                    @if ($form->productId !== 'all')
                        <div class="col-md-1 ">
                            ...
                            <div wire:ignore class="col-lg-12 fv-row">
                                ...
                                <button type="button" wire:click="addProduct" class="btn btn-primary btn-rounded"
                                    style="margin-top:14px;"><i class="fa-solid fa-plus"></i> </button>
                            </div>
                ...
                <div class="row mb-8">
                    @foreach ($selectedProducts as $selectedProduct)
                        ...
                        <div class="col-md-2">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6">
                                {{ $selectedProduct['customer_min_amount'] }}
                                </lable>
                        </div>
                        <div class="col-md-2">
                            <label class="col-lg-12 col-form-label fw-semibold fs-6">
                                {{ $selectedProduct['product_min_amount'] }}
                                </lable>
                        </div>
                        <div class="col-md-1">
                            </lable>
                            <a style="cursor: pointer" wire:click="removeProduct({{ $selectedProduct['id'] }})"
        ...
        Alpine.data('custgroup', () => {
            ...
            $('#productId').select2({
                ...
                if (typeof Livewire !== "undefined" && typeof Livewire.dispatch === "function") {
                    Livewire.dispatch('productChanged', {
                        productId: productId
                    }); // Livewire v3+
                } else if (typeof Livewire.emit === "function") {
                    Livewire.emit('productChanged', productId); // Livewire v2
                } else {
                    console.error("Livewire is not loaded or emit function is missing!");
                }
            });
